...
{
    public class PipeMapDemandController : ApiController
    {
        ...
        public NimoMap.RootObject Get()
        {
            ...
            PL_DEMAND_INFORepository repDemandInfo = new PL_DEMAND_INFORepository(connectionString);
            List<PL_DEMAND_INFO> listDemandInfo = repDemandInfo.GetData();
