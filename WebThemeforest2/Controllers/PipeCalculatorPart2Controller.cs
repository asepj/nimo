...
{
    public class pipecalculatorPart2Controller : ApiController
    {
        ...
        public PositionParam Post(PositionParam origin)
        {
            ...
            try
            {
                ...
                string area = listCal[0].FILE_NAME;
        ...
        //calcultate manual
        [Route("api/PipeCalculator/CalculateRoute")]
        [HttpPost]
        ...
        public PositionParam CalculateManual(PositionParam origin)
        {
            ...
            try
            {
                ...
                //if (origin.areaPipeline == "Kerawang")
                //{

                //    origin.myUrl = ToAbsoluteUrl("~/Scripts/KarawangFacilities.js");
                //}

                //else if (origin.areaPipeline == "Jakarta")
                //{

                //    origin.myUrl = ToAbsoluteUrl("~/Scripts/PipesRD1.js");
                //}
        ...
        //calcultate manual
        [Route("api/PipeCalculator/CalculateManual")]
        [HttpPost]

        public PositionParam CalculateCost(PositionParam origin)
        {
            Thread.CurrentThread.CurrentCulture = CultureInfo.GetCultureInfo("en-US");
            int myRowNumber = 0;
            string myMessage = "";
            ...
            try
            {
                ...
                //List<PL_CONFIG_PRESSURE_REGIME> list1 = rep0.GetDataByREGIME_NAME(origin.pressureRegime);
                //double pressure = list1[0].MAX.Value;
        ...
        [Route("api/PipeCalculator/GetDataNPS")]
        [HttpPost]
        public IQueryable<PL_CONFIG_PIPELINE> GetDataNPS([FromBody]PL_CONFIG_PIPELINE pl_config_pipeline)
        {
            PL_CONFIG_PIPELINERepository rep1 = new PL_CONFIG_PIPELINERepository(connectionString);
            List<PL_CONFIG_PIPELINE> list = rep1.GetDataNPSPart2(pl_config_pipeline);
            return list.AsQueryable();
        }

        [Route("api/PipeCalculator/Regime")]
        [HttpPost]
        public IQueryable Regime([FromBody] PL_CONFIG_PRESSURE_REGIME regime)
        {
         
            PL_CONFIG_PRESSURE_REGIMERepository rep0 = new PL_CONFIG_PRESSURE_REGIMERepository(connectionString);

            List<PL_CONFIG_PRESSURE_REGIME> list2 = rep0.GetDataByREGIME_NAME(regime.REGIME_NAME);
