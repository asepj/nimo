...
{
    public class PipeCalculatorManualController : ApiController
    {
        ...
        public PositionParam Run_Post_Postalcode_manual(PositionParam origin)
        {
            Thread.CurrentThread.CurrentCulture = CultureInfo.GetCultureInfo("en-US");
            int myRowNumber = 0;
            string myMessage = "";
        ...
        //[Route("api/PipeCalculatorManual/CalculateManual")]
        //[HttpPost]
