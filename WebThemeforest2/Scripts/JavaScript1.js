...
var margin = { top: 50, right: 0, bottom: 100, left: 30 },
    ...
    times = ["1a", "1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a", "11a", "12p", "1p", "2p", "3p", "4p", "5p", "6p", "7p", "8p", "9p", "10p", "11p"];
...
var getRequest = function(file)
{
    ...
    var dataPost = { DATE_STAMP: "2012-01-01", AREA: "type1" };
    //get data from database
    $.ajax({
        type: "GET",
        url: "http://localhost:32271/api/SiteVisit",
        contentType: "application/json",
        dataType: "json",
        crossOrigin: false,
        success: function (data) {
            //var t0 = [["02/2013", 1500], ["03/2013", 2500], ["04/2013", 1700], ["05/2013", 800], ["06/2013", 1500], ["07/2013", 2350], ["08/2013", 1500], ["09/2013", 1300], ["10/2013", 4600]];
            var strDateRange = document.getElementById("dashboard-report-range").value;
            var strDateRange2 = $("#dashboard-report-range");
            var t = data;
    ...
    d3.xhr(" http://localhost:32271/api/CapacityUtilization")
        .header("Content-Type", "application/json")
        .post(
            JSON.stringify({ DATE_STAMP: "2012-01-01", AREA: "type1" }),
    ...
    //d3.request("http://localhost/Nimo/api/CapacityUtilization")
...
var heatmapChart2 = function (tsvFile) {
    ...
    var data = myDataset;
        ...
        var minValue2 = d3.min(myDataset, function (d) { return parseInt(d.value); });
        var maxValue2 = d3.max(myDataset, function (d) { return parseInt(d.value); });
...
datasetpicker.enter()
  ...
  .on("click", function (d) {
      var objDate = $('input[name="daterange"]');
      heatmapChart(d);
  });
